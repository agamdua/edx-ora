...
def regenerate_course_data():
    ...
    for course in courses:
        get_course_data_in_csv_format.delay(course=course)

@task()
def get_course_data_in_csv_format(course):
    """
    ...
    for (i, location) in enumerate(locations):
        ...
        for sub in subs:
            ...
            if keys is None:
                ...
                writer = csv.DictWriter(string_write, keys, dialect='ora')
                writer.writeheader()
